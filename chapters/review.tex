...
\section{Волновое уравнение и оптические моды}
...
\section{Асимметричный метод расщепления Фурье}
...
\section{Нейронные сети и обучение с учителем}
...
\section{Алгоритм цифрового обратного распространения}
...
Параметризованный SSM, представленный в предыдущем разделе, и его оптимизация с использованием различных инструментов машинного обучения,
называется обученным DBP (LDBP)
